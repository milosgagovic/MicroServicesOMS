...
namespace ScadaStatelessService
{
    /// <summary>
    /// An instance of this class is created for each service instance by the Service Fabric runtime.
    /// </summary>
    internal sealed class ScadaStatelessService : StatelessService
    {
        public ScadaStatelessService(StatelessServiceContext context)
            : base(context)
        { }
        ...
        protected override IEnumerable<ServiceInstanceListener> CreateServiceInstanceListeners()
        {
            return new List<ServiceInstanceListener>()
            {
                ...
                new ServiceInstanceListener(context => this.CreateWcfCommunicationListener(context), "ScadaEndpoint"),
        ...
        private ICommunicationListener CreateWcfCommunicationListener(StatelessServiceContext context)
        {
            ...
            var endpointConfig = context.CodePackageActivationContext.GetEndpoint("ScadaEndpoint");
