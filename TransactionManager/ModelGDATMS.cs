  ...
  public class ModelGDATMS
    {
        ...
        public ResourceDescription GetValues(long globalId)
        {
            ...
            try
            {
                ...
                rd = ProxyToNMServiceFabric.InvokeWithRetry(client => client.Channel.GetValues(globalId, properties));
        ...
        public List<ResourceDescription> GetExtentValues(ModelCode modelCode)
        {
            ...
            try
            {
                ...
                iteratorId = ProxyToNMServiceFabric.InvokeWithRetry(client => client.Channel.GetExtentValues(modelCode, properties));
